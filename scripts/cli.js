...
const contractABI = require("../artifacts/contracts/Compassmeld.sol/Compassmeld.json").abi;

program
    .name("compassmeld-cli")
    .description("CLI tool for Compassmeld smart contract")
    .version("1.0.0");
